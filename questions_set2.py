questions_set2 = [
    
    {
        ...
        "options": [
            "A BSS is a single network segment, while an ESS is a collection of multiple BSSs.",
            "A BSS requires an access point, while an ESS does not.",
            "A BSS is used for personal networks, while an ESS is used for public networks.",
    ...
    },
    {
        ...
        "options": [
            "A network segment where devices connect directly without an access point.",
            "A network segment managed by a central controller.",
            "A network segment with an access point facilitating communication.",
            "A network segment used in personal area networks."
        ],
        "correct_answer": 1,
    ...
    {
    "question": "What does PBSS stand for in the context of wireless networks?",
    "options": [
    ...
    "correct_answer": 1,
    "description": "PBSS (Personal Basic Service Set) is defined in IEEE 802.11ad and refers to a service set where a single device, called a PBSS control point (PCP), coordinates communication between devices in the service set. It is typically used in personal area networks."
    },
    ...
    },
{
    ...
    "options": [
        "It relies on a central device called an Access Point (AP) to connect wireless devices to a wired network.",
        "Devices communicate directly with each other without the need for an Access Point (AP).",
        "It combines features of both infrastructure and ad-hoc WLANs.",
        "It uses multiple APs that work together to provide seamless coverage."
    ],
    "correct_answer": 1,
...
},
{
    ...
    "options": [
        "It relies on a central Access Point (AP) to manage communication between devices.",
        "Devices communicate directly with each other without the need for an Access Point (AP).",
        "It uses multiple APs that work together to provide seamless coverage.",
        "It combines features of both infrastructure and ad-hoc WLANs."
    ],
...
{
    "question": "What makes a Hybrid WLAN unique?",
    "options": [
        "It relies on a central Access Point (AP) to connect wireless devices to a wired network.",
        "Devices communicate directly with each other without the need for an Access Point (AP).",
        "It combines features of both infrastructure and ad-hoc WLANs, allowing devices to communicate directly or through an AP.",
        "It uses multiple APs that work together to provide seamless coverage."
    ],
    "correct_answer": 3,
...
{
    "question": "What is the key characteristic of a Mesh WLAN?",
    "options": [
        "It relies on a central Access Point (AP) to manage all network communication.",
        "Devices communicate directly with each other without the need for an Access Point (AP).",
        "It combines features of both infrastructure and ad-hoc WLANs.",
        "It uses multiple Access Points (APs) that work together to provide seamless coverage, with each AP acting as a node."
    ],
    "correct_answer": 4,
    "description": "Mesh WLAN uses multiple Access Points (APs) that work together to provide seamless coverage. Each AP acts as a node, relaying data to other nodes to ensure connectivity across a large area."
},
    ...
    },
{
    ...
    "options": [
        "To plan and design a wireless network ensuring desired coverage, capacity, and performance requirements are met.",
        "To verify that the network meets the intended design specifications after deployment.",
        "To monitor network traffic and optimize bandwidth usage.",
        "To prioritize certain types of network traffic to maintain performance."
    ],
    "correct_answer": 1,
...
{
    "question": "What is Validation Coverage in the context of wireless networks?",
    "options": [
        "The process of planning and designing a wireless network to ensure optimal coverage.",
        "The process of verifying that the network meets the intended design specifications after deployment.",
        "The continuous monitoring of network performance and traffic.",
        "The implementation of security measures to protect the network."
    ],
    "correct_answer": 2,
...

    {
        ...
        "options": [
            "To establish and maintain connections between devices.",
            "To carry the actual data payload between devices.",
            "To manage access to the wireless medium.",
            "To validate the network performance after deployment."
        ],
        "correct_answer": 1,
    ...
    },
{
    ...
    "options": [
        "They are used to establish and maintain connections between devices.",
        "They help manage access to the wireless medium and ensure proper communication.",
        "They carry the actual data payload being transmitted between devices.",
        "They are used for encrypting and securing the wireless network."
    ],
    "correct_answer": 2,
...
},
{
    ...
    "options": [
        "They carry the actual data payload being transmitted between devices on the network.",
        "They establish and maintain connections between devices.",
        "They help manage access to the wireless medium and ensure proper communication.",
        "They are used for network security and encryption."
    ],
    "correct_answer": 1,
...
},
{
    ...
    "options": [
        "Each access point operates independently, managing its own clients and configuration.",
        "Access points are managed by a central controller, which handles configuration, client associations, and network policies.",
        "Control and data plane functionalities are distributed across access points and controllers.",
        "Devices communicate directly with each other without the need for an access point."
    ],
    "correct_answer": 2,
...
},
{
    ...
    "options": [
        "Each access point operates independently, managing its own clients and configuration.",
        "It is simpler to deploy and easier to manage in large networks.",
        "Control and data plane functionalities are distributed across access points and controllers, providing flexibility and scalability.",
        "Devices communicate directly with each other without the need for an access point."
    ],
    "correct_answer": 3,
...

{
...

    {
        ...
        "options": [
            "Ensuring equal access to the wireless medium for all devices.",
            "Prioritizing certain types of network traffic.",
            "Allowing faster devices to monopolize the channel.",
            "Using multiple BSSs to extend network coverage."
        ],
        "correct_answer": 1,
...

{
    ...
    "options": [
        "The ability to prioritize certain types of network traffic to ensure that critical applications receive the necessary bandwidth and low latency.",
        "The process of encrypting data transmitted over the network to ensure security.",
        "The technique used to manage access points in a centralized WLAN.",
        "The method of measuring signal strength in a WiFi network."
    ],
    "correct_answer": 1,
    ...
    },
{
    ...
    "options": [
        "It operates in the 5 GHz band and offers speeds up to 54 Mbps using OFDM.",
        "It operates in the 2.4 GHz band and offers speeds up to 11 Mbps using DSSS.",
        "It operates in both 2.4 GHz and 5 GHz bands and offers speeds up to 600 Mbps using MIMO.",
        "It operates in the 5 GHz band and offers speeds up to several Gbps using wider channels."
    ],
    "correct_answer": 1,
...
},
{
    ...
    "options": [
        "It operates in the 5 GHz band and offers speeds up to 54 Mbps using OFDM.",
        "It operates in the 2.4 GHz band, offers speeds up to 54 Mbps using OFDM, and is backward compatible with 802.11b devices.",
        "It operates in both 2.4 GHz and 5 GHz bands and offers speeds up to 600 Mbps using MIMO.",
        "It operates in the 5 GHz band and offers speeds up to several Gbps using wider channels."
    ],
    "correct_answer": 2,
...
},
{
    ...
    "options": [
        "It operates in the 5 GHz band and offers speeds up to 54 Mbps using OFDM.",
        "It operates in the 2.4 GHz band and offers speeds up to 11 Mbps using DSSS.",
        "It operates in both 2.4 GHz and 5 GHz bands, offers speeds up to 600 Mbps using MIMO and channel bonding, and improves range and reliability.",
        "It operates in the 5 GHz band and offers speeds up to several Gbps using wider channels."
    ],
    "correct_answer": 3,
...
},
{
    ...
    "options": [
        ...
        "It operates in the 2.4 GHz band and offers speeds up to 11 Mbps using DSSS.",
        "It operates in both 2.4 GHz and 5 GHz bands and offers speeds up to 600 Mbps using MIMO.",
        "It operates in the 5 GHz band, offers speeds up to several Gbps using wider channels, more MIMO streams, and advanced modulation techniques."
    ],
    "correct_answer": 4,
...

    {
        ...
        "options": [
            "To connect two separate networks, extending the coverage area.",
            "To operate as the central hub for a BSS.",
            "To extend the range of an existing wireless network.",
            "To passively monitor WiFi traffic."
        ],
        "correct_answer": 1,
...
# Question about Mesh Mode in Access Points
{
...
# Question about Infrastructure Mode in Clients
{
    ...
    "options": [
        ...
        "The client passively monitors WiFi traffic without actively participating in the network.",
...
# Question about Ad-Hoc Mode in Clients
{
...
# Question about Monitor Mode in Clients
{
    ...
    "options": [
        ...
        "The client connects directly to other devices without an AP.",
        "The client passively monitors WiFi traffic without actively participating in the network.",
        "The client acts as a central hub for managing network traffic."
    ],
    "correct_answer": 3,
    ...
    },
{
    ...
    "options": [
        ...
        "Devices transmit data simultaneously and correct any errors after transmission.",
        "Devices establish a direct connection before transmitting data to avoid collisions.",
        "Devices use encryption to secure data transmission and avoid collisions."
    ],
    "correct_answer": 1,
...

    {
        ...
        "options": [
            "Combining predictive modeling and on-site measurements for network design.",
            "A process of assessing network performance after deployment.",
            "A method of managing network traffic.",
...
# Question about Predictive Modeling
{
    ...
    "options": [
        "To use software tools to simulate the wireless environment, estimating coverage, capacity, and interference based on building layouts and material properties.",
        "To physically measure signal strength, interference, and network performance in the actual environment.",
        "To validate that the network meets the desired performance criteria after deployment.",
        "To continuously monitor the network and resolve any issues that arise."
    ],
    "correct_answer": 1,
...
# Question about On-Site Survey
{
    "question": "What is the role of an On-Site Survey in wireless network design?",
    "options": [
        "To simulate the wireless environment using software tools.",
        "To physically measure signal strength, interference, and network performance in the actual environment.",
        "To validate that the network meets the desired performance criteria after deployment.",
        "To continuously monitor the network and resolve any issues that arise."
    ],
...
# Question about Validation Testing
{
    "question": "What is the purpose of Validation Testing in wireless network deployment?",
    "options": [
        "To simulate the wireless environment and estimate coverage and capacity.",
        "To measure signal strength and interference during the on-site survey.",
        "To ensure that the network meets the desired performance criteria after deployment.",
        "To continuously monitor the network for any issues."
    ],
    "correct_answer": 3,
...
# Question about Ongoing Monitoring
{
    "question": "What is the role of Ongoing Monitoring in a wireless network?",
    "options": [
        "To simulate the wireless environment and estimate interference.",
        "To physically measure network performance during deployment.",
        "To validate that the network meets performance criteria after deployment.",
        "To continuously monitor the network and resolve any issues, ensuring that the network remains optimized over time."
    ],
    "correct_answer": 4,
